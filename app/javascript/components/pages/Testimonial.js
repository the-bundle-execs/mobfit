  ...
  render() {
    return(
      <div>
        ...
        <p className="mb-0">I am so happy to be part of my very own MobFit family.
        ...
        <footer className="blockquote-footer"> Albus Dumbledore </footer>
        <br/>
        <p className="mb-0">I met my wife during a MobFit event. She was talking trash about my under arm throw,
        ...
        <footer className="blockquote-footer">Tom Cruise  </footer>
        <br/>
